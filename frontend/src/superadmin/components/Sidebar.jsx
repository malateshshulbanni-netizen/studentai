...
const Sidebar = ({ isOpen, setIsOpen, isCollapsed, setIsCollapsed }) => {
  const menuItems = [
    ...
    { path: '/super-admin/institutions', icon: Building2, label: 'Institutions' },
        ...
        <div className={`p-4 border-b border-[#24348A] flex items-center ${isCollapsed ? 'lg:justify-between' : 'lg:justify-between'}`}>
          {isCollapsed ? (
            <>
              ...
              {/* Collapse Toggle Button - Same line as SD when collapsed */}
              <button
            ...
            <>
              <div>
                ...
                <p className="text-xs text-white/60 mt-1">Super Admin Panel</p>
              </div>
